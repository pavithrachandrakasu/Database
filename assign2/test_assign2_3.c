...
void testLRU_K (void)
{
  ...
  const char *poolContents[] = { 
    ...
    /* use some of the page to create a fixed LRU_K order(1) without changing pool content */
    "[0 0],[1 0],[2 0]",
    "[0 0],[1 0],[2 0]",
    "[0 0],[1 0],[2 0]",
    "[0 0],[1 0],[2 0]",
  ...
  const int orderRequests[] = {2,1,0,2,1};
  ...
  /* reading first three pages linearly with direct unpin and no modifications*/
  for(i = 0; i < 3 ; i++)
  {
      pinPage(bm, h, i);
      unpinPage(bm, h);
