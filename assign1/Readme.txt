Assignment 1 - CS 525 Advanced Database Organization
...
1) In the terminal, navigate to the assign1 directory.
...
Additional Test Cases Written for:
----------------------------------
i)readBlock()
ii)readNextBlock()
iii)readLastBlock()
iv)readPreviousBlock()
v)ensureCapacity()
vi)appendEmptyBlock()
vii) writeCurrentBlock()
viii) readCurrentBlock()
xi) getBlockPos()

For running additional test cases:
----------------------------------
